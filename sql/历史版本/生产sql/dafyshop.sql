...
Source Server         : 10.12.11.109_8066
Source Server Version : 50629
Source Host           : 10.12.11.109:8066
...
CREATE TABLE `t_fn_repayment_jrn` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=599 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='蜂鸟还款流水';
...
CREATE TABLE `t_goods_call_traffic_supplier` (
  ...
  `purchase_price` bigint(20) DEFAULT NULL COMMENT '进货价',
  `official_price` bigint(20) DEFAULT NULL COMMENT '官方价格',
  `discount_rate` int(11) DEFAULT NULL COMMENT '折扣x100',
  `limit_discount_rate` int(255) DEFAULT NULL COMMENT '限制折扣率x100',
  `operator` int(11) DEFAULT NULL COMMENT '0:中国移动，1：中国联通，2：中国电信',
  `product_type` int(11) DEFAULT NULL COMMENT '产品类型：0：话费，1：流量',
...
CREATE TABLE `t_goods_sku` (
  ...
  `sale_price` bigint(20) DEFAULT NULL COMMENT '售价',
  `default_sku_code` int(11) DEFAULT NULL COMMENT '默认sku',
...
CREATE TABLE `t_goods_sku_img` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品明细主图';
...
CREATE TABLE `t_goods_specification` (
  ...
  `status` int(4) DEFAULT '0' COMMENT '状态：\r\n0： 可用，\r\n1：不可用',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品规格属性';
...
CREATE TABLE `t_goods_specification_value` (
  ...
  `last_modify` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品规格属性值';
...
CREATE TABLE `t_goods_spu` (
  ...
  `is_iphone` int(11) DEFAULT NULL COMMENT '是否是苹果手机:1：苹果手机，0：非苹果手机',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品表（SPU）';
...
CREATE TABLE `t_goods_types` (
  ...
  `last_modify` bigint(20) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品分类(后台)';
...
CREATE TABLE `t_jd_accesstoken` (
  ...
  `gmt_modified` datetime(3) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=177 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='京东accesstoken信息';
...
CREATE TABLE `t_jd_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='京东配置信息';
...
CREATE TABLE `t_jd_goods_sku` (
  ...
  `price` bigint(20) DEFAULT NULL COMMENT '协议价格',
  `jd_price` bigint(20) DEFAULT NULL COMMENT '京东价格',
  `weight` decimal(18,3) DEFAULT NULL COMMENT '重量',
  ...
  `app_introduce` text COLLATE utf8mb4_unicode_ci,
  `introduction` text COLLATE utf8mb4_unicode_ci,
  `param` text COLLATE utf8mb4_unicode_ci,
  `ware_qd` varchar(1024) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1923 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='京东商品池';
...
CREATE TABLE `t_jd_goods_sku_img` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19116 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='京东商品图片';
...
CREATE TABLE `t_jd_order_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='京东下单明细';
...
CREATE TABLE `t_jd_orders` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='京东下单记录';
...
) ENGINE=InnoDB AUTO_INCREMENT=344349 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `t_shop_order_contract_log` (
  ...
  `status` tinyint(1) DEFAULT NULL COMMENT '状态: 0-取消合同失败, 1-取消合同成功',
  `create_time` bigint(20) DEFAULT NULL COMMENT '创建时间',
  `last_modify` bigint(20) DEFAULT NULL COMMENT '更新时间',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='订单合同日志表';
...
CREATE TABLE `t_shop_order_detail` (
  ...
  `interest_rate` int(3) DEFAULT NULL COMMENT '利率优惠, 蜂鸟需要',
  `operator` int(11) DEFAULT NULL COMMENT '运营商：0:中国移动，1：中国联通，2：中国电信',
  `discount_amount` bigint(20) DEFAULT NULL COMMENT '优惠金额',
  `is_iphone` tinyint(1) DEFAULT NULL COMMENT '是否为苹果手机',
  `fn_insurance_id` int(11) DEFAULT NULL COMMENT '蜂鸟保险id',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=632 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='订单明细';
...
CREATE TABLE `t_shop_order_pay` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=232 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='订单支付方式';
...
CREATE TABLE `t_shop_order_refunds_pay_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='第三方退款日志记录表';
...
CREATE TABLE `t_shop_order_repayment_plan` (
  ...
  `capital` bigint(18) DEFAULT NULL COMMENT '本金',
  `interest` bigint(18) DEFAULT NULL COMMENT '利息',
  `last_modify` bigint(20) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='订单还款计划';
...
CREATE TABLE `t_shop_orders` (
  ...
  `amount` bigint(18) DEFAULT NULL COMMENT '结算金额(商品总价+运费-优惠)',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=717 DEFAULT CHARSET=utf8 COMMENT='订单';
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='单号生成器';
...
CREATE TABLE `t_system_sms_verification` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1741 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='短信验证码验证记录表';
...
CREATE TABLE `t_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=213 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='登录账号信息';
