...
-- CUS_CONTACT_ADDRESS, FK_CUS_BASE_INFO_CS_PERSON导入商城数据库
...
WHERE addr.ADDRESS_TYPE = 'CA05' AND addr.STATE = true AND addr.CREATE_TIME > '2017-10-30 18:00:00' AND addr.CREATE_TIME <= '2017-11-08 19:00:00'
)
AS fn_address;
